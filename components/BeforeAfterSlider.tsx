  ...
  return (
    <div className="flex flex-col items-center">
      <div className="mb-4 text-center">
        ...
        <span className="text-xs text-orange-700 font-bold uppercase tracking-widest">{location}</span>
      </div>
      ...
      <div 
        ...
        className="relative w-full aspect-[16/10] max-w-4xl rounded-2xl overflow-hidden cursor-ew-resize shadow-2xl focus:outline-none focus:ring-4 focus:ring-orange-500 focus:ring-opacity-50"
      >
        {/* Before Image */}
        ...
        >
          ...
          <span className="absolute bottom-4 right-4 bg-orange-600 text-white text-[10px] font-bold px-3 py-1 rounded backdrop-blur-md">
        ...
        >
          <div className="w-10 h-10 bg-orange-600 rounded-full border-4 border-white flex items-center justify-center shadow-lg -translate-x-1/2">
      ...
      <div className="mt-4 flex items-center space-x-6 text-xs font-bold text-gray-500 uppercase tracking-widest">
        <div className="flex items-center">
          <span className="w-2 h-2 bg-orange-600 rounded-full mr-2" aria-hidden="true"></span>
